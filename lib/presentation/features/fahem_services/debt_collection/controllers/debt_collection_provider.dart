...
class DebtCollectionProvider with ChangeNotifier {
  ...
  List<LawyerModel> _debtCollection = [];
  List<LawyerModel> get debtCollection => _debtCollection;
  setDebtCollection(List<LawyerModel> debtCollection) => _debtCollection = debtCollection;
  changeDebtCollection(List<LawyerModel> debtCollection) {
