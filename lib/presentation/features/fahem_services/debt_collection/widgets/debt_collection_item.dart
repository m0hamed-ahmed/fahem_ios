...
class DebtCollectionItem extends StatefulWidget {
  final LawyerModel lawyerModel;

  const DebtCollectionItem({super.key, required this.lawyerModel});

  @override
  State<DebtCollectionItem> createState() => _DebtCollectionItemState();
}

class _DebtCollectionItemState extends State<DebtCollectionItem> {
  ...
  Widget build(BuildContext context) {
    double distanceKm = Geolocator.distanceBetween(debtCollectionProvider.myCurrentPositionLatitude, debtCollectionProvider.myCurrentPositionLongitude, widget.lawyerModel.latitude, widget.lawyerModel.longitude)/1000;
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(SizeManager.s10),
          onTap: () {
           debtCollectionProvider.googleMapController.animateCamera(CameraUpdate.newLatLng(LatLng(widget.lawyerModel.latitude, widget.lawyerModel.longitude)));
           debtCollectionProvider.changeMakers({
             Marker(
