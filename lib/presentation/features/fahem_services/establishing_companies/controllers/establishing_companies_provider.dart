...
class EstablishingCompaniesProvider with ChangeNotifier {
  ...
  List<LawyerModel> _establishingCompanies = [];
  List<LawyerModel> get establishingCompanies => _establishingCompanies;
  setEstablishingCompanies(List<LawyerModel> establishingCompanies) => _establishingCompanies = establishingCompanies;
  changeEstablishingCompanies(List<LawyerModel> establishingCompanies) {
    _establishingCompanies = establishingCompanies;
  ...
  void showDataInList({required bool isResetData, required bool isRefresh, required bool isScrollUp}) async {
    ...
    if(_hasMoreData) {
      List list = _establishingCompanies;
