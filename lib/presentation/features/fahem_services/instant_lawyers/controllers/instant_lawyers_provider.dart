...
class InstantLawyersProvider with ChangeNotifier {
  ...
  List<LawyerModel> _instantLawyers = [];
  List<LawyerModel> get instantLawyers => _instantLawyers;
  setInstantLawyers(List<LawyerModel> instantLawyers) => _instantLawyers = instantLawyers;
  changeInstantLawyers(List<LawyerModel> instantLawyers) {
    _instantLawyers = instantLawyers;
