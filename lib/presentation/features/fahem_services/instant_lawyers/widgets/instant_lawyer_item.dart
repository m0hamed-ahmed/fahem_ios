...
class InstantLawyerItem extends StatefulWidget {
  final LawyerModel lawyerModel;

  const InstantLawyerItem({super.key, required this.lawyerModel});

  @override
  State<InstantLawyerItem> createState() => _InstantLawyerItemState();
}

class _InstantLawyerItemState extends State<InstantLawyerItem> {
  ...
  Widget build(BuildContext context) {
    double distanceKm = Geolocator.distanceBetween(instantLawyersProvider.myCurrentPositionLatitude, instantLawyersProvider.myCurrentPositionLongitude, widget.lawyerModel.latitude, widget.lawyerModel.longitude)/1000;
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(SizeManager.s10),
          onTap: () {
           instantLawyersProvider.googleMapController.animateCamera(CameraUpdate.newLatLng(LatLng(widget.lawyerModel.latitude, widget.lawyerModel.longitude)));
