...
class RealEstateLegalAdviceItem extends StatefulWidget {
  final LawyerModel lawyerModel;

  const RealEstateLegalAdviceItem({super.key, required this.lawyerModel});

  @override
  State<RealEstateLegalAdviceItem> createState() => _RealEstateLegalAdviceItemState();
}

class _RealEstateLegalAdviceItemState extends State<RealEstateLegalAdviceItem> {
  ...
  Widget build(BuildContext context) {
    double distanceKm = Geolocator.distanceBetween(realEstateLegalAdviceProvider.myCurrentPositionLatitude, realEstateLegalAdviceProvider.myCurrentPositionLongitude, widget.lawyerModel.latitude, widget.lawyerModel.longitude)/1000;
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(SizeManager.s10),
          onTap: () {
           realEstateLegalAdviceProvider.googleMapController.animateCamera(CameraUpdate.newLatLng(LatLng(widget.lawyerModel.latitude, widget.lawyerModel.longitude)));
           realEstateLegalAdviceProvider.changeMakers({
             Marker(
