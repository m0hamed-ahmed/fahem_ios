...
class RealEstateLegalAdviceProvider with ChangeNotifier {
  ...
  List<LawyerModel> _realEstateLegalAdvice = [];
  List<LawyerModel> get realEstateLegalAdvice => _realEstateLegalAdvice;
  setRealEstateLegalAdvice(List<LawyerModel> realEstateLegalAdvice) => _realEstateLegalAdvice = realEstateLegalAdvice;
  changeRealEstateLegalAdvice(List<LawyerModel> realEstateLegalAdvice) {
    _realEstateLegalAdvice = realEstateLegalAdvice;
  ...
  void showDataInList({required bool isResetData, required bool isRefresh, required bool isScrollUp}) async {
    ...
    if(_hasMoreData) {
      List list = _realEstateLegalAdvice;
