...
class SecretConsultationFormProvider with ChangeNotifier {
  ...
  void onPressedSendConsultation(BuildContext context, TransactionModel transactionModel) {
    ...
    int serviceCost = settingsProvider.settings.secretConsultationPrice;

    Dialogs.showPayConfirmationDialog(
      context: context,
      title: Methods.getText(StringsManager.payTheCostOfTheSecretConsultation, appProvider.isEnglish).toCapitalized(),
                ...
                response.fold((failure) async {
                  ...
                  response.fold((failure) async {
                    ...
                    response.fold((failure) async {
                      ...
                      NotificationService.pushNotification(topic: FirebaseConstants.fahemAdminTopic, title: 'استشارة سرية', body: 'العميل محمد قام بارسال استشارة سرية');
                      changeIsLoading(false);
                      ...
                      Dialogs.showBottomSheetMessage(
                        context: context,
                        message: '${Methods.getText(StringsManager.yourSecretConsultationHasBeenSentToFahemExpertsAndYouWillBeContactedWithin24HoursViaAPhoneNumber, appProvider.isEnglish).toCapitalized()} ${transactionModel.phoneNumber}',
