...
class InvestmentLegalAdviceProvider with ChangeNotifier {
  ...
  List<LawyerModel> _investmentLegalAdvice = [];
  List<LawyerModel> get investmentLegalAdvice => _investmentLegalAdvice;
  setInvestmentLegalAdvice(List<LawyerModel> investmentLegalAdvice) => _investmentLegalAdvice = investmentLegalAdvice;
  changeInvestmentLegalAdvice(List<LawyerModel> investmentLegalAdvice) {
    _investmentLegalAdvice = investmentLegalAdvice;
  ...
  void showDataInList({required bool isResetData, required bool isRefresh, required bool isScrollUp}) async {
    ...
    if(_hasMoreData) {
      List list = _investmentLegalAdvice;
