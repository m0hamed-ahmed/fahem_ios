...
class InvestmentLegalAdviceItem extends StatefulWidget {
  final LawyerModel lawyerModel;

  const InvestmentLegalAdviceItem({super.key, required this.lawyerModel});

  @override
  State<InvestmentLegalAdviceItem> createState() => _InvestmentLegalAdviceItemState();
}

class _InvestmentLegalAdviceItemState extends State<InvestmentLegalAdviceItem> {
  ...
  Widget build(BuildContext context) {
    double distanceKm = Geolocator.distanceBetween(investmentLegalAdviceProvider.myCurrentPositionLatitude, investmentLegalAdviceProvider.myCurrentPositionLongitude, widget.lawyerModel.latitude, widget.lawyerModel.longitude)/1000;
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(SizeManager.s10),
          onTap: () {
           investmentLegalAdviceProvider.googleMapController.animateCamera(CameraUpdate.newLatLng(LatLng(widget.lawyerModel.latitude, widget.lawyerModel.longitude)));
           investmentLegalAdviceProvider.changeMakers({
             Marker(
