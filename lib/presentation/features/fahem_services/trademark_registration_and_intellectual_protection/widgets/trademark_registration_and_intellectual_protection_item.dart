...
class TrademarkRegistrationAndIntellectualProtectionItem extends StatefulWidget {
  final LawyerModel lawyerModel;

  const TrademarkRegistrationAndIntellectualProtectionItem({super.key, required this.lawyerModel});

  @override
  State<TrademarkRegistrationAndIntellectualProtectionItem> createState() => _TrademarkRegistrationAndIntellectualProtectionItemState();
}

class _TrademarkRegistrationAndIntellectualProtectionItemState extends State<TrademarkRegistrationAndIntellectualProtectionItem> {
  ...
  Widget build(BuildContext context) {
    double distanceKm = Geolocator.distanceBetween(trademarkRegistrationAndIntellectualProtectionProvider.myCurrentPositionLatitude, trademarkRegistrationAndIntellectualProtectionProvider.myCurrentPositionLongitude, widget.lawyerModel.latitude, widget.lawyerModel.longitude)/1000;
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(SizeManager.s10),
          onTap: () {
           trademarkRegistrationAndIntellectualProtectionProvider.googleMapController.animateCamera(CameraUpdate.newLatLng(LatLng(widget.lawyerModel.latitude, widget.lawyerModel.longitude)));
           trademarkRegistrationAndIntellectualProtectionProvider.changeMakers({
             Marker(
