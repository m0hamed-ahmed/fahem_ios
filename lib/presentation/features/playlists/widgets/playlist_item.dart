...
class PlaylistItem extends StatefulWidget {
  ...
  const PlaylistItem({super.key, required this.playlistModel, required this.index});
...
class _PlaylistItemState extends State<PlaylistItem> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        children: [
          // if(widget.playlistModel.videos.isNotEmpty) CachedNetworkImageWidget(image: Methods.getYoutubeThumbnail(YoutubePlayer.convertUrlToId(widget.playlistModel.videos.first.link)!)),
          SizedBox(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${widget.playlistModel.videos.length} ${Methods.getText(StringsManager.videos, appProvider.isEnglish).toTitleCase()}',
